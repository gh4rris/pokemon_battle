...
class Battle(ctk.CTkLabel):
    def __init__(self, frame, window, player, opponent):
        ...
        # Widgets
        self.fight_button = ctk.CTkButton(self.frame, text="Fight", state="disabled", command=self.fight_frame.frame_place, font=("Arial", min(window.width // 35, window.height // 35), "bold"), corner_radius=20, fg_color="#17e3e3", border_color="#0fbfbf", border_width=2, text_color="#555577", text_color_disabled="#8888AA", hover_color="#0eeded")
        self.change_pokemon_button = ctk.CTkButton(self.frame, text="Change Pokemon", state="disabled", command=self.change_frame.frame_place, font=("Arial", min(window.width // 35, window.height // 35), "bold"), corner_radius=20, fg_color="#17e3e3", border_color="#0fbfbf", border_width=2, text_color="#555577", text_color_disabled="#8888AA", hover_color="#0eeded")
        self.item_button = ctk.CTkButton(self.frame, text="Item", state="disabled", command=self.item_frame.frame_place, font=("Arial", min(window.width // 35, window.height // 35), "bold"), corner_radius=20, fg_color="#17e3e3", border_color="#0fbfbf", border_width=2, text_color="#555577", text_color_disabled="#8888AA", hover_color="#0eeded")
        self.run_button = ctk.CTkButton(self.frame, text="Run", state="disabled", command=self.run, font=("Arial", min(window.width // 35, window.height // 35), "bold"), corner_radius=20, fg_color="#17e3e3", border_color="#0fbfbf", border_width=2, text_color="#555577", text_color_disabled="#8888AA", hover_color="#0eeded")
        self.next_text = None
        self.next_button = ctk.CTkButton(frame, text="Next", command=self.progress_text, anchor="se", state="disabled", font=("Arial", min(window.width // 35, window.height // 35), "bold"), corner_radius=20, fg_color="#24d459", border_color="#1db34a", border_width=2, text_color="#CCEECC", text_color_disabled="#557755", hover_color="#18e054")
        self.yes_button = ctk.CTkButton(self.frame, text="Yes", command=lambda: opponent.yes_player_change(self), font=("Arial", min(window.width // 35, window.height // 35), "bold"), corner_radius=20, fg_color="#17e3e3", border_color="#0fbfbf", border_width=2, text_color="#555577", text_color_disabled="#8888AA", hover_color="#0eeded")
        self.no_button = ctk.CTkButton(self.frame, text="No", command=lambda: opponent.no_player_change(self), font=("Arial", min(window.width // 35, window.height // 35), "bold"), corner_radius=20, fg_color="#17e3e3", border_color="#0fbfbf", border_width=2, text_color="#555577", text_color_disabled="#8888AA", hover_color="#0eeded")
